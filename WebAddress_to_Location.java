...
public class WebAddress_to_Location {
    public static void main(String[] args) throws IOException, ParserConfigurationException, SAXException {
        WebAddress_to_Location objmain = new WebAddress_to_Location();
        objmain.get_response();
    }
    public void get_response() throws IOException, ParserConfigurationException, SAXException {
        // write your code here
        Scanner scanner = new Scanner(System.in);
        System.out.print("Enter the address which location you want to get: ");
        String scan = scanner.nextLine();
        InetAddress myIP = InetAddress.getByName(scan);
        System.out.println(scan+" IP address is: "+myIP.getHostAddress());
